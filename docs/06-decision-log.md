...
- **NEXT (in progress):** Stage 5 step A done (D32). **Step C partly done (D33)** — Method Library §5 seeded from JRC 2013 *(EC7 guidance)*; still to add Look 2007 Ch 21/23 *(non-code)* fallbacks + the AU pack (AS 5100.3 §10 + φg) to §5. **Step B** — task-level In/Does/Out/Gates procedures for 5.0–5.7 (mirroring `02-interpretation-procedures.md`). Then repeat the three-step treatment for **axial pile** (Stage 6) — JRC 2013 Ch 8/Annex A.8 has worked pile examples to reuse.
